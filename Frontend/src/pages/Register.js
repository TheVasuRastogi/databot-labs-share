...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!passwordRegex.test(formData.password)) {
      setError('Password must be at least 8 characters and contain a number, uppercase, lowercase, and special character (!@#$%^&*)');
      setIsLoading(false);
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-[#030014] text-white relative overflow-hidden flex items-center justify-center py-8 sm:py-12 px-4 sm:px-6 antialiased">
      <Helmet>
        <title>Register | DataBot-Labs - Robotics Innovation</title>
        <meta name="description" content="Create your DataBot-Labs account to access our robotics solutions and services." />
      </Helmet>
      ...
      <div className="relative z-10 w-full max-w-[20rem] sm:max-w-[26rem]">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-400/80">
            Join us on your robotics journey
          </p>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-300/90 mb-1.5 sm:mb-2">
                Full Name
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <FaUser className="text-purple-400/50 w-4 h-4" />
                </div>
                <input
                  type="text"
                  id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-300/90 mb-1.5 sm:mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
