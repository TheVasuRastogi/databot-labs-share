...
const ProductDetails = () => {
  ...
  const products = {
    '1': {
      name: 'Goliath Robot Arm',
      category: 'Robots',
      image: '/images/goliath_black.jpg',
    ...
    return (
      <div className="min-h-screen bg-white text-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/" className="text-gray-700 hover:text-black underline">Return to Home</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen w-full bg-white text-black relative">
      <SEOHelmet 
        title={`${product?.name} | DataBot Labs`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex items-center justify-center gap-3 px-8 py-4 bg-gray-800 text-white rounded-xl font-semibold text-lg hover:bg-gray-900 transition-all duration-300"
                >
                  <FaPlay />
                  Watch Demo
                </button>
                <button
                  ...
                  className="flex items-center justify-center gap-3 px-8 py-4 bg-white border border-gray-300 rounded-xl font-semibold text-lg hover:bg-gray-50 transition-all duration-300 text-black"
                >
                  <FaShoppingCart />
                  {addingToCart ? 'Redirecting...' : 'Get Quote'}
                </button>
              </div>
            </motion.div>
            ...
            >
              <div className="relative aspect-video rounded-2xl overflow-hidden bg-gray-100 border border-gray-200">
                ...
                >
                  <div className="w-20 h-20 rounded-full bg-black/30 flex items-center justify-center group-hover:bg-black/40 transition-all duration-300">
      ...
      <div className="container mx-auto px-4 relative z-10 py-20 w-full max-w-full">
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gray-800 text-white px-6 py-2 rounded-full text-sm font-semibold">
                      Most Popular
                    </span>
                  </div>
                )}
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="relative aspect-video rounded-2xl overflow-hidden bg-gray-100 border border-gray-200">
              ...
              <button
                ...
                className="absolute inset-0 flex items-center justify-center group"
              >
                <div className="w-24 h-24 rounded-full bg-black/30 flex items-center justify-center group-hover:bg-black/40 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {product.features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="text-center p-6 rounded-2xl bg-gray-50 border border-gray-200 hover:border-gray-300 transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {activeTab === 'specs' ? (
              Object.entries(product.specs).map(([key, section]) => (
                <div
                  key={key}
                  className="p-6 rounded-2xl bg-gray-50 border border-gray-200 hover:border-gray-300 transition-colors duration-300"
                >
                  ...
                  <div className="space-y-3">
                    {items.map((item, index) => (
                      <div key={index} className="flex items-center">
                        <FaCheckCircle className="text-gray-600 mr-3 flex-shrink-0" />
                  ...
                  {product.features.map((feature, index) => (
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        <div className="text-3xl text-gray-700 flex-shrink-0">
                          {feature.icon}
                        </div>
                        <div>
